# Update für Martin - Heartbeat-Check 2026-05-03 07:15
...
### Option 1: Manuell über GitHub UI (empfohlen)
...
- **Ohne Workflow:** Kein automatischer Build bei Push/PR
- **Mit Workflow:** Automatische Windows-Builds auf GitHub Actions
- **EXE-Verfügbarkeit:** Selbstständige Windows-EXE als Download verfügbar

## Empfehlung

**Option 1 wählen** (manuell über GitHub UI) – das ist der schnellste Weg und erfordert keine Token-Änderungen.
